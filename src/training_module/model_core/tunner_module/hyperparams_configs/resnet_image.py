...
resnet_image_space = ModelHyperparameterSpace(
    ...
    parameters={
        ...
        "resnet_model_name": HyperparameterConfig(
            type="categorical",
        ...
        "unfreeze_after_epoch": HyperparameterConfig(type="int", low=0, high=10, values=[0, 2, 5, 10]),
        "gradient_clip_value": HyperparameterConfig(type="float", low=0.1, high=2.0, values=[0.1, 0.5, 1.0, 1.5, 2.0]),
    },
    tuner_configs={
