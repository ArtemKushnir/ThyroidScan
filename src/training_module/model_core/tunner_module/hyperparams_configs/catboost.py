...
catboost_space = ModelHyperparameterSpace(
    model_name="catboost",
    parameters={
        "iterations": HyperparameterConfig(type="int", low=100, high=3000, values=[100, 300, 500, 700, 1000, 3000]),
        "depth": HyperparameterConfig(type="int", low=4, high=10, values=[4, 6, 8, 10]),
        "learning_rate": HyperparameterConfig(type="float", low=0.01, high=0.3, log=True, values=[0.01, 0.05, 0.1]),
